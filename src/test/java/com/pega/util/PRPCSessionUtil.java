...
public class PRPCSessionUtil
{
        ...
        try {
            ...
            while (true) {
                ...
                if ("Set-Cookie".equals(headerName)) {
                    PRPCSessionUtil.cookie = ((PRPCSessionUtil.cookie == null) ? headerValue : (String.valueOf(PRPCSessionUtil.cookie) + headerValue + ";"));
                }
    ...
    public static void importRAP(String filePath, final TestEnvironment testEnv) throws IOException {
        ...
        if (config != null) {
            filePath = String.valueOf(config.getParent()) + File.separator + filePath;
        }
        ...
        if (prpcUrl.contains("PRServlet")) {
            ...
            prpcUrl = String.valueOf(prpcUrl) + "/";
        }
        final String archiveName = String.valueOf(DataUtil.getRandomNumberString("selenium.RAP.")) + ".jar";
        final String restUrl = String.valueOf(prpcUrl) + "PRRestService" + "/BuildSmoke/Utility/ImportRAP?archivename=" + archiveName + "&keep=false";
    ...
    public static void cloneOperator(final TestEnvironment testEnv, final String aSourceOperator, final String aTargetOperator, final boolean aKeepCaseType) {
        ...
        try {
            restURL = String.valueOf(restURL.endsWith("/") ? restURL : new StringBuilder(String.valueOf(restURL)).append("/").toString()) + "PRRestService/BuildSmoke/Utility/CloneOperator?";
            restURL = String.valueOf(restURL) + "SourceOperator=" + URLEncoder.encode(aSourceOperator, "UTF-8");
            restURL = String.valueOf(restURL) + "&TargetOperator=" + URLEncoder.encode(aTargetOperator, "UTF-8");
            restURL = String.valueOf(restURL) + "&KeepCaseType=" + aKeepCaseType;
    ...
    public static void oatuhCloneOperator(final TestEnvironment testEnv, final String aSourceOperator, final String aTargetOperator, final boolean aKeepCaseType, final String tokenID) {
        ...
        String restURL = aURL.substring(0, indx);
        try {
            restURL = String.valueOf(restURL.endsWith("/") ? restURL : new StringBuilder(String.valueOf(restURL)).append("/").toString()) + "PRRestService/OAuth20Package/Utility/CloneOperator?";
            restURL = String.valueOf(restURL) + "SourceOperator=" + URLEncoder.encode(aSourceOperator, "UTF-8");
            restURL = String.valueOf(restURL) + "&TargetOperator=" + URLEncoder.encode(aTargetOperator, "UTF-8");
            restURL = String.valueOf(restURL) + "&KeepCaseType=" + aKeepCaseType;
            System.out.println("REST URL: '" + restURL + "'");
    ...
    public static void addUIKitToApplication(final TestEnvironment testEnv, final String application, final String applicationVersion) {
        ...
        String restURL = aURL.substring(0, indx);
        try {
            restURL = String.valueOf(restURL.endsWith("/") ? restURL : new StringBuilder(String.valueOf(restURL)).append("/").toString()) + "PRRestService/BuildSmoke/Utility/AddUIKitToApplication?";
            restURL = String.valueOf(restURL) + "&appName=" + URLEncoder.encode(application, "UTF-8");
            restURL = String.valueOf(restURL) + "&appVersion=" + applicationVersion;
            System.out.println("REST URL: '" + restURL + "'");
            final URL url = new URL(restURL);
            conn = (HttpURLConnection)url.openConnection();
            final String userPassword = "newbuildsmokedeveloper:pega";
    ...
    public static void addUIKitToApplication(final String aURL, final String application, final String applicationVersion, final boolean addExpressUIKit, final int insertAtPosition) throws Exception {
        ...
        try {
            ...
            restURL = String.valueOf(restURL) + "appName=" + URLEncoder.encode(application, "UTF-8");
            restURL = String.valueOf(restURL) + "&appVersion=" + applicationVersion;
            restURL = String.valueOf(restURL) + "&insertAtPosition=" + insertAtPosition;
    ...
    public static void addUIKitToRuleset(final String aURL, final String ruleset, final String rulesetVersion) throws Exception {
        ...
        String restURL = aURL.substring(0, indx);
        try {
            restURL = String.valueOf(restURL.endsWith("/") ? restURL : new StringBuilder(String.valueOf(restURL)).append("/").toString()) + "PRRestService/BuildSmoke/Utility/AddUIKitToRuleset?";
            restURL = String.valueOf(restURL) + "rulesetName=" + URLEncoder.encode(ruleset, "UTF-8");
            restURL = String.valueOf(restURL) + "&rulesetVersion=" + rulesetVersion;
            Reporter.log("REST URL: '" + restURL + "'", true);
            final URL url = new URL(restURL);
            conn = (HttpURLConnection)url.openConnection();
            final String userPassword = "newbuildsmokedeveloper:pega";
    ...
    public static void addRulesetToApplication(final String aURL, final String application, final String applicationVersion, final String rulesetNameWithVersion) throws Exception {
        ...
        String restURL = aURL.substring(0, indx);
        try {
            restURL = String.valueOf(restURL.endsWith("/") ? restURL : new StringBuilder(String.valueOf(restURL)).append("/").toString()) + "PRRestService/BuildSmoke/Utility/AddRulesetToApplication?";
            restURL = String.valueOf(restURL) + "SourceApplicationName=" + URLEncoder.encode(application, "UTF-8");
            restURL = String.valueOf(restURL) + "&SourceApplicationVersion=" + applicationVersion;
            restURL = String.valueOf(restURL) + "&RulesetName=" + rulesetNameWithVersion;
            Reporter.log("REST URL: '" + restURL + "'", true);
            final URL url = new URL(restURL);
            conn = (HttpURLConnection)url.openConnection();
            final String userPassword = "newbuildsmokedeveloper:pega";
