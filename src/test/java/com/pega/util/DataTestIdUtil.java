...
public class DataTestIdUtil
{
                        ...
                        try {
                            ...
                            while (in2.hasNextLine()) {
                                ...
                                if (element != null && element.contains(elementFromList.trim())) {
                                    ...
                                    if (split2.length == 2) {
                                        DataTestIdUtil.elementVariableName = String.valueOf(DataTestIdUtil.elementVariableName) + split2[1].trim() + "\n";
                                    }
                                    else {
                                        DataTestIdUtil.elementVariableName = String.valueOf(DataTestIdUtil.elementVariableName) + "_" + "\n";
                                    }
                                    DataTestIdUtil.location = String.valueOf(DataTestIdUtil.location) + temp.getAbsolutePath() + "::line" + linenum + "\n";
                                }
                                else {
                                    if (element == null) {
                                        continue;
                                    ...
                                    if (change1.contains("By.linkText(")) {
                                        ...
                                        if (split4.length == 2) {
                                            DataTestIdUtil.elementVariableName = String.valueOf(DataTestIdUtil.elementVariableName) + split4[1].trim() + "\n";
                                        }
                                        else {
                                            DataTestIdUtil.elementVariableName = String.valueOf(DataTestIdUtil.elementVariableName) + "_" + "\n";
                                        }
                                        ...
                                        for (int j = 0; j < changesplit2.length; ++j) {
                                            if (!changesplit2[j].contains("text()")) {
                                                if (!changesplit2[j].contains("(") && !changesplit2[j].contains(")")) {
                                                    finalpath2 = String.valueOf(finalpath2) + "'" + changesplit2[j] + "'";
                                                    finalpath3 = String.valueOf(finalpath3) + "'" + changesplit2[j] + "'";
                                                }
                                                else {
                                                    finalpath2 = String.valueOf(finalpath2) + changesplit2[j];
                                                    finalpath3 = String.valueOf(finalpath3) + changesplit2[j];
                                                ...
                                                if (!changesplit2[j + 1].contains("(") && !changesplit2[j + 1].contains(")")) {
                                                    finalpath2 = String.valueOf(finalpath2) + "'\"+LocalizationUtil.getLocalizedWord(\"" + changesplit2[j + 1] + "\")+\"'";
                                                    finalpath3 = String.valueOf(finalpath3) + "\"+LocalizationUtil.getLocalizedWord(\"'" + changesplit2[j + 1] + "'\")+\"";
                                                }
                                                ++j;
                                            }
                                        }
                                        if (element.contains(finalpath2.trim())) {
                                            ...
                                            if (split6.length == 2) {
                                                DataTestIdUtil.elementVariableName = String.valueOf(DataTestIdUtil.elementVariableName) + split6[1].trim() + "\n";
                                            }
                                            else {
                                                DataTestIdUtil.elementVariableName = String.valueOf(DataTestIdUtil.elementVariableName) + "_" + "\n";
                                            }
                                    ...
                                    while (reader1.hasNextLine()) {
                                        ...
                                        if (s2 != null) {
                                                    ...
                                                    for (int f2 = 0; f2 < changesplit.length; ++f2) {
                                                        if (!changesplit[f2].contains("text()")) {
                                                            if (!changesplit[f2].contains("(") && !changesplit[f2].contains(")")) {
                                                                finalpath = String.valueOf(finalpath) + "'" + changesplit[f2] + "'";
                                                                finalpath2 = String.valueOf(finalpath2) + "'" + changesplit[f2] + "'";
                                                            }
                                                            else {
                                                                finalpath = String.valueOf(finalpath) + changesplit[f2];
                                                                finalpath2 = String.valueOf(finalpath2) + changesplit[f2];
                                                            ...
                                                            if (!changesplit[f2 + 1].contains("(") && !changesplit[f2 + 1].contains(")")) {
                                                                finalpath = String.valueOf(finalpath) + "'\"+LocalizationUtil.getLocalizedWord(\"" + changesplit[f2 + 1] + "\")+\"'";
                                                                finalpath2 = String.valueOf(finalpath2) + "\"+LocalizationUtil.getLocalizedWord(\"'" + changesplit[f2 + 1] + "'\")+\"";
                                                            }
                                                            ++f2;
                                                        }
                                                    }
                                            ...
                                            try {
                                                ...
                                                Files.write(javafile.toPath(), fileContent, StandardCharsets.UTF_8, new OpenOption[0]);
                                            }
    ...
    public static void percentageDetails(final String excelBookName, final String sheetName, final String sheetname1) throws IOException {
        ...
        try {
            ...
            cell.setCellValue((double)totalElements);
            cell = row2.createCell(1);
            cell.setCellValue((double)(totalElements - datatestIdnotused));
            cell = row2.createCell(2);
            cell.setCellValue((double)(totalElements - (totalElements - datatestIdnotused)));
            cell = row2.createCell(3);
            if (totalElements != 0) {
                cell.setCellValue(String.valueOf(100 - datatestIdnotused * 100 / totalElements) + "%");
            }
            if (DataTestIdUtil.FIS != null) {
                DataTestIdUtil.FIS.close();
            }
