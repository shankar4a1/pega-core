...
import com.pega.exceptions.PegaMailException;
...
public class MailUtil
{
    ...
    public static boolean sendEmail(final Host mailHost, final String senderEmailId, final String senderPassword, final String toEmailId, final String subject, final String body) {
        ...
        try {
            ...
            message.setFrom((Address)new InternetAddress(senderEmailId));
            message.addRecipient(Message.RecipientType.TO, (Address)new InternetAddress(toEmailId));
            message.setSubject(subject);
            message.setContent((Object)body, "text/plain; charset=UTF-8");
    ...
    private static Message readMessage(final Folder emailFolder, final FlagTerm flagTerm, final String subjectMatch) throws MessagingException {
        final Message[] messages = emailFolder.search((SearchTerm)flagTerm);
        Message message = null;
        ...
        Label_0384: {
            try {
                if (downloadDirectory == null) {
                    ...
                    downloadDirectory = String.valueOf(DataUtil.getDataFolder()) + System.getProperty("file.separator") + "Attachments";
                }
                ...
                for (int i = 0; i < content.getCount(); ++i) {
                    ...
                    if (o instanceof String) {
                        ...
                        inStream = new ByteArrayInputStream(textContent.getBytes(Charset.forName("UTF-8")));
                    }
                        ...
                        f = new File(String.valueOf(dir.getAbsolutePath()) + System.getProperty("file.separator") + fileName);
                        if (f.exists()) {
                            f.delete();
                        }
                        f.createNewFile();
    ...
    public enum Host
    {
        ...
        private Host(final String name, final int ordinal, final String hostName, final String port) {
    ...
    public enum Timeout
    {
        ...
        private Timeout(final String name, final int ordinal, final int value) {
            this.value = value;
        }
