...
public class RefactorMethodsCalls
{
    ...
    private void makeMethodsInAccessible() {
        final File f = new File(String.valueOf(System.getenv("WORKSPACE")) + System.getProperty("file.separator") + "stepdefs" + System.getProperty("file.separator") + "com" + System.getProperty("file.separator") + "pega" + System.getProperty("file.separator") + "MyTestEnvironment.java");
        if (f.exists()) {
            f.delete();
