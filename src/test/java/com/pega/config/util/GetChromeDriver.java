...
public class GetChromeDriver
{
        ...
        try {
            ...
            if (Integer.parseInt(majorVersion) > 72) {
                ...
                if (latestVersion.toLowerCase().contains("error")) {
                    ...
                    response = client.execute((HttpUriRequest)getRequest);
    ...
    private static void getChromeDriver(final String chromeDriverVersion) throws ClientProtocolException, IOException {
    ...
    private static void downloadChromeDriver(final String url) throws IOException, ClientProtocolException, FileNotFoundException {
        final HttpClient client = (HttpClient)HttpClientBuilder.create().build();
        final HttpGet getRequest = new HttpGet(url);
        final HttpResponse response = client.execute((HttpUriRequest)getRequest);
    ...
    private static String getLocalChromeVersion() throws Exception, IOException {
        String output = null;
