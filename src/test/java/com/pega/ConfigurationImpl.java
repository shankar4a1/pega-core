...
import com.pega.config.browser.FirefoxConfig;
    ...
    public String getCredential(final String propertyName) {
        if (this.usersProperties == null) {
            ...
            try {
                ...
                if (!f.exists()) {
                    f = new File(String.valueOf(DataUtil.getDataFolder()) + System.getProperty("file.separator") + "users.properties");
                }
                final String parent = this.configFile.getParent();
                if (parent != null && parent.contains("giza")) {
                    f = new File(String.valueOf(parent) + System.getProperty("file.separator") + "users.properties");
                }
    ...
    public String getApplicationsForTag(final Collection<String> tags) {
        if (this.tagApplicationProperties == null) {
            ...
            try {
                ...
                if (!f.exists()) {
                    f = new File(String.valueOf(DataUtil.getDataFolder()) + System.getProperty("file.separator") + "TagsAndApplications.properties");
                }
        ...
        for (final String tag : tags) {
            if (this.tagApplicationProperties.containsKey(tag)) {
                applications = String.valueOf(applications) + this.tagApplicationProperties.getProperty(tag) + ",";
            }
        }
