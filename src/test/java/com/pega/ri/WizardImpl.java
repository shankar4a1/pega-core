...
public class WizardImpl extends FrameImpl implements Wizard
{
    ...
    public void refresh() {
        ...
        this.pegaDriver.handleWaits().waitForElementVisibility((WebElement)refLink);
    ...
    public void newOperator(final String operator, final String applicationaname) {
        ...
        this.pegaDriver.waitForDocStateReady();
        this.findElement(By.xpath("//input[contains(@name,'pyLabel')]")).sendKeys(String.valueOf(applicationaname) + ":Administrators");
        this.findElement(By.xpath("//input[contains(@name,'pyLabel')]")).sendKeys((CharSequence)Keys.TAB);
        this.pegaDriver.waitForDocStateReady();
    }
    ...
    public Wizard findWizard(final String frameId) {
        ...
        wizard._setDOMPointer(String.valueOf(this.getFrameDocument()) + ".defaultView.frames['" + frameId + "']");
